          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
            {canGoBack && (
              <button
                ...
                className='text-purple-800 hover:text-purple-800 font-medium transition-colors focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 px-4 py-2 rounded-lg'
